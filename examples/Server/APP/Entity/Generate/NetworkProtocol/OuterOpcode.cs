...
namespace Fantasy
{
    ...
    public static partial class OuterOpcode
    {
        ...
        public const uint C2G_GoddessOverflow = 268445468;
        /// <summary> 溢出入库裁决响应 </summary>
        public const uint G2C_GoddessOverflowResponse = 402663196;
        /// <summary> 客户端玩法界面双击背包元素道具、请求取回一个到盘面(服务端权威 -1;身份从会话取) </summary>
        public const uint C2G_RetrieveElement = 268445469;
        /// <summary> 取回裁决响应(成功后客户端再把元素飞回盘面) </summary>
        public const uint G2C_RetrieveElementResponse = 402663197;
        ...
        public const uint C2G_UseItem = 268445470;
        /// <summary> 服务端使用道具裁决响应。 </summary>
        public const uint G2C_UseItemResponse = 402663198;
        ...
        public const uint C2G_MailListRequest = 268445471;
        /// <summary> 服务端拉列表响应（该账号应收、未过期的邮件 + 每封领取态）（§3.2） </summary>
        public const uint G2C_MailListResponse = 402663199;
        /// <summary> 客户端领取一封邮件请求（身份从会话取，不携带账号）（§3.3） </summary>
        public const uint C2G_MailClaimRequest = 268445472;
        /// <summary> 服务端领取裁决响应（结果码 + 成功时奖励列表）（§3.4） </summary>
        public const uint G2C_MailClaimResponse = 402663200;
        /// <summary> 客户端请求交付某槽位的订单(身份从会话取,不带账号 / 不带订单类型 / 不带奖励金额——服务端按 OrderCursor + DeliveredMask 自己定) </summary>
        public const uint C2G_DeliverOrderRequest = 268445473;
        /// <summary> 服务端交付裁决响应 </summary>
        public const uint G2C_DeliverOrderResponse = 402663201;
        public const uint C2G_TestEmptyMessage = 134227730;
        public const uint C2G_TestMessage = 134227731;
        public const uint C2G_TestRequest = 268445474;
        public const uint G2C_TestResponse = 402663202;
        ...
        public const uint C2G_CreateAddressableRequest = 268445475;
        public const uint G2C_CreateAddressableResponse = 402663203;
        ...
        public const uint C2G_CreateChatRouteRequest = 268445476;
        public const uint G2C_CreateChatRouteResponse = 402663204;
        ...
        public const uint C2G_CreateSubSceneRequest = 268445477;
        public const uint G2C_CreateSubSceneResponse = 402663205;
        ...
        public const uint C2G_CreateSubSceneAddressableRequest = 268445478;
        public const uint G2C_CreateSubSceneAddressableResponse = 402663206;
        ...
        public const uint C2G_ConnectRoamingRequest = 268445479;
        public const uint G2C_ConnectRoamingResponse = 402663207;
        ...
        public const uint C2G_LoginRoamingRequest = 268445480;
        public const uint G2C_LoginRoamingResponse = 402663208;
        /// <summary> 通知Gate服务器发送一个内网消息通知Map服务器向Gate服务器注册一个领域事件 </summary>
        public const uint C2G_SubscribeSphereEventRequest = 268445481;
        public const uint G2C_SubscribeSphereEventResponse = 402663209;
        /// <summary> 通知Gate发送一个订阅领域事件 </summary>
        public const uint C2G_PublishSphereEventRequest = 268445482;
        public const uint G2C_PublishSphereEventResponse = 402663210;
        /// <summary> 通知Gate取消一个订阅领域事件 </summary>
        public const uint C2G_UnsubscribeSphereEventRequest = 268445483;
        public const uint G2C_UnsubscribeSphereEventResponse = 402663211;
        /// <summary> 通知Map取消一个订阅领域事件 </summary>
        public const uint C2G_MapUnsubscribeSphereEventRequest = 268445484;
        public const uint G2C_MapUnsubscribeSphereEventResponse = 402663212;
        public const uint C2G_TestMemoryPackRequest = 285222701;
        public const uint G2C_TestMemoryPackResponse = 419440429;
        ...
        public const uint C2G_PropertyChangeRequest = 268445486;
        /// <summary> 服务端属性变更裁决响应(§3.3.2) </summary>
        public const uint G2C_PropertyChangeResponse = 402663214;
        ...
        public const uint C2G_PropertyBatchChangeRequest = 268445487;
        /// <summary> 服务端批量变更逐项裁决响应(Results 顺序与请求 Items 一一对应;客户端也按 Type 匹配双保险) </summary>
        public const uint G2C_PropertyBatchChangeResponse = 402663215;
        /// <summary> 客户端拉 ledger 流水请求(身份从会话取,不携带账号)(§3.1) limit 必填(本子单不设默认);服务端钳制 [0, 100],超上限钳为 100 不报错(降级语义)。 </summary>
        public const uint C2G_QueryAttrLedger = 268445488;
        /// <summary> 服务端查询响应(§3.2) </summary>
        public const uint G2C_QueryAttrLedgerResponse = 402663216;
        /// <summary> 客户端全量上报三态(身份从会话取,不带账号;SET 语义,服务端存客户端设的值 + sanity) </summary>
        public const uint C2G_SetProfileStateRequest = 268445489;
        /// <summary> 服务端设置三态裁决响应(回带当前权威三态供客户端对账) </summary>
        public const uint G2C_SetProfileStateResponse = 402663217;
        /// <summary> 客户端上报一次成绩请求（玩法结束提交；身份从会话取，不携带账号）（§3.1） </summary>
        public const uint C2G_RankSubmitScoreRequest = 268445490;
        /// <summary> 服务端上报裁决响应（结果码 + 当前最佳）（§3.2） </summary>
        public const uint G2C_RankSubmitScoreResponse = 402663218;
        /// <summary> 客户端查榜请求（不分页，返展示上限条数；身份从会话取，不携带账号）（§3.4） </summary>
        public const uint C2G_RankQueryRequest = 268445491;
        /// <summary> 服务端查榜响应（前 N 名条目 + 自己名次 + 自己分数）（§3.5） </summary>
        public const uint G2C_RankQueryResponse = 402663219;
        /// <summary> 客户端提交兑换码请求（玩家身份从会话取，不在请求中携带账号） </summary>
        public const uint C2G_RedeemCodeRequest = 268445492;
        /// <summary> 服务端兑换裁决响应 </summary>
        public const uint G2C_RedeemCodeResponse = 402663220;
        /// <summary> 客户端请求改名(身份从会话取,不带账号 / 不带费用 / 不带次数——服务端按 PlayerDoc.RenameCount 自己算) </summary>
        public const uint C2G_RenameRequest = 268445493;
        /// <summary> 服务端改名裁决响应 </summary>
        public const uint G2C_RenameResponse = 402663221;
        /// <summary> 客户端请求购买一步塔罗牌进度(身份从会话取;本步成本由服务端按 TbTarotCard.UnlockCosts[当前步] 自算,客户端不上报) </summary>
        public const uint C2G_TarotPurchaseRequest = 268445494;
        /// <summary> 服务端购买裁决响应 </summary>
        public const uint G2C_TarotPurchaseResponse = 402663222;
        ...
        public const uint C2G_WishForEnergyRequest = 268445495;
        /// <summary> 服务端祈愿裁决响应 </summary>
        public const uint G2C_WishForEnergyResponse = 402663223;
        /// <summary> 客户端请求清空自己的玩家数据(身份从会话取,不携带 playerId / 不接受指定清别人) </summary>
        public const uint C2G_ClearPlayerDataRequest = 268445496;
        /// <summary> 服务端清档裁决响应 </summary>
        public const uint G2C_ClearPlayerDataResponse = 402663224;
        /// <summary> 客户端 GM 清盘请求(身份从会话取,不携带账号) </summary>
        public const uint C2G_ClearBoardRequest = 268445497;
        /// <summary> 服务端清盘裁决 + 最新权威态 </summary>
        public const uint G2C_ClearBoardResponse = 402663225;
        /// <summary> 客户端 GM 清背包请求(身份从会话取,不携带账号) </summary>
        public const uint C2G_ClearInventoryRequest = 268445498;
        /// <summary> 服务端清背包裁决响应 </summary>
        public const uint G2C_ClearInventoryResponse = 402663226;
        /// <summary> 客户端 GM 发测试道具请求(身份从会话取,不携带账号) </summary>
        public const uint C2G_GrantTestItemRequest = 268445499;
        /// <summary> 服务端发测试道具裁决响应 </summary>
        public const uint G2C_GrantTestItemResponse = 402663227;
    }
}