...
namespace Fantasy
{
    ...
    public static partial class OuterOpcode
    {
        ...
        public const uint C2G_BuyEnergyRequest = 268445462;
        /// <summary> 服务端购买体力裁决响应 </summary>
        public const uint G2C_BuyEnergyResponse = 402663190;
        /// <summary> 客户端请求换装(身份从会话取,不带账号;服务端校验目标已解锁才切换) </summary>
        public const uint C2G_EquipCosmeticRequest = 268445463;
        /// <summary> 服务端换装裁决响应 </summary>
        public const uint G2C_EquipCosmeticResponse = 402663191;
        /// <summary> 客户端上报解锁(client-report:客户端按等级配置算出解锁、上报 id,服务端 sanity 后幂等加入集合) </summary>
        public const uint C2G_UnlockCosmeticRequest = 268445464;
        /// <summary> 服务端解锁上报裁决响应 </summary>
        public const uint G2C_UnlockCosmeticResponse = 402663192;
        /// <summary> 客户端批量上报解锁(一次携带 N 项,身份从会话取) </summary>
        public const uint C2G_UnlockCosmeticBatchRequest = 268445465;
        /// <summary> 服务端批量解锁裁决响应(回带处理后两个 kind 的最终解锁集) </summary>
        public const uint G2C_UnlockCosmeticBatchResponse = 402663193;
        /// <summary> 客户端进入主游戏(登录后、主游戏可交互前发起;每次进入主游戏阶段调用一次) </summary>
        public const uint C2G_EnterMainGameRequest = 268445466;
        /// <summary> 服务端对进入主游戏请求的响应:订单快照 + 道具持有 + 塔罗进度 </summary>
        public const uint G2C_EnterMainGameResponse = 402663194;
        ...
        public const uint C2G_GoddessClaimRequest = 268445468;
        /// <summary> 服务端女神领取裁决响应 </summary>
        public const uint G2C_GoddessClaimResponse = 402663196;
        /// <summary> 客户端上报女神奖励盘面溢出、请求入库(元素道具按数量落 ItemBag;身份从会话取,不带账号——反作弊红线) </summary>
        public const uint C2G_GoddessOverflow = 268445469;
        /// <summary> 溢出入库裁决响应 </summary>
        public const uint G2C_GoddessOverflowResponse = 402663197;
        /// <summary> 客户端玩法界面双击背包元素道具、请求取回一个到盘面(服务端权威 -1;身份从会话取) </summary>
        public const uint C2G_RetrieveElement = 268445470;
        /// <summary> 取回裁决响应(成功后客户端再把元素飞回盘面) </summary>
        public const uint G2C_RetrieveElementResponse = 402663198;
        ...
        public const uint C2G_UseItem = 268445471;
        /// <summary> 服务端使用道具裁决响应。 </summary>
        public const uint G2C_UseItemResponse = 402663199;
        ...
        public const uint C2G_MailListRequest = 268445472;
        /// <summary> 服务端拉列表响应（该账号应收、未过期的邮件 + 每封领取态）（§3.2） </summary>
        public const uint G2C_MailListResponse = 402663200;
        /// <summary> 客户端领取一封邮件请求（身份从会话取，不携带账号）（§3.3） </summary>
        public const uint C2G_MailClaimRequest = 268445473;
        /// <summary> 服务端领取裁决响应（结果码 + 成功时奖励列表）（§3.4） </summary>
        public const uint G2C_MailClaimResponse = 402663201;
        /// <summary> 客户端请求交付某槽位的订单(身份从会话取,不带账号 / 不带订单类型 / 不带奖励金额——服务端按 OrderCursor + DeliveredMask 自己定) </summary>
        public const uint C2G_DeliverOrderRequest = 268445474;
        /// <summary> 服务端交付裁决响应 </summary>
        public const uint G2C_DeliverOrderResponse = 402663202;
        public const uint C2G_TestEmptyMessage = 134227730;
        public const uint C2G_TestMessage = 134227731;
        public const uint C2G_TestRequest = 268445475;
        public const uint G2C_TestResponse = 402663203;
        ...
        public const uint C2G_CreateAddressableRequest = 268445476;
        public const uint G2C_CreateAddressableResponse = 402663204;
        ...
        public const uint C2G_CreateChatRouteRequest = 268445477;
        public const uint G2C_CreateChatRouteResponse = 402663205;
        ...
        public const uint C2G_CreateSubSceneRequest = 268445478;
        public const uint G2C_CreateSubSceneResponse = 402663206;
        ...
        public const uint C2G_CreateSubSceneAddressableRequest = 268445479;
        public const uint G2C_CreateSubSceneAddressableResponse = 402663207;
        ...
        public const uint C2G_ConnectRoamingRequest = 268445480;
        public const uint G2C_ConnectRoamingResponse = 402663208;
        ...
        public const uint C2G_LoginRoamingRequest = 268445481;
        public const uint G2C_LoginRoamingResponse = 402663209;
        /// <summary> 通知Gate服务器发送一个内网消息通知Map服务器向Gate服务器注册一个领域事件 </summary>
        public const uint C2G_SubscribeSphereEventRequest = 268445482;
        public const uint G2C_SubscribeSphereEventResponse = 402663210;
        /// <summary> 通知Gate发送一个订阅领域事件 </summary>
        public const uint C2G_PublishSphereEventRequest = 268445483;
        public const uint G2C_PublishSphereEventResponse = 402663211;
        /// <summary> 通知Gate取消一个订阅领域事件 </summary>
        public const uint C2G_UnsubscribeSphereEventRequest = 268445484;
        public const uint G2C_UnsubscribeSphereEventResponse = 402663212;
        /// <summary> 通知Map取消一个订阅领域事件 </summary>
        public const uint C2G_MapUnsubscribeSphereEventRequest = 268445485;
        public const uint G2C_MapUnsubscribeSphereEventResponse = 402663213;
        public const uint C2G_TestMemoryPackRequest = 285222702;
        public const uint G2C_TestMemoryPackResponse = 419440430;
        ...
        public const uint C2G_PropertyChangeRequest = 268445487;
        /// <summary> 服务端属性变更裁决响应(§3.3.2) </summary>
        public const uint G2C_PropertyChangeResponse = 402663215;
        ...
        public const uint C2G_PropertyBatchChangeRequest = 268445488;
        /// <summary> 服务端批量变更逐项裁决响应(Results 顺序与请求 Items 一一对应;客户端也按 Type 匹配双保险) </summary>
        public const uint G2C_PropertyBatchChangeResponse = 402663216;
        /// <summary> 客户端拉 ledger 流水请求(身份从会话取,不携带账号)(§3.1) limit 必填(本子单不设默认);服务端钳制 [0, 100],超上限钳为 100 不报错(降级语义)。 </summary>
        public const uint C2G_QueryAttrLedger = 268445489;
        /// <summary> 服务端查询响应(§3.2) </summary>
        public const uint G2C_QueryAttrLedgerResponse = 402663217;
        /// <summary> 客户端全量上报三态(身份从会话取,不带账号;SET 语义,服务端存客户端设的值 + sanity) </summary>
        public const uint C2G_SetProfileStateRequest = 268445490;
        /// <summary> 服务端设置三态裁决响应(回带当前权威三态供客户端对账) </summary>
        public const uint G2C_SetProfileStateResponse = 402663218;
        /// <summary> 客户端上报一次成绩请求（玩法结束提交；身份从会话取，不携带账号）（§3.1） </summary>
        public const uint C2G_RankSubmitScoreRequest = 268445491;
        /// <summary> 服务端上报裁决响应（结果码 + 当前最佳）（§3.2） </summary>
        public const uint G2C_RankSubmitScoreResponse = 402663219;
        /// <summary> 客户端查榜请求（不分页，返展示上限条数；身份从会话取，不携带账号）（§3.4） </summary>
        public const uint C2G_RankQueryRequest = 268445492;
        /// <summary> 服务端查榜响应（前 N 名条目 + 自己名次 + 自己分数）（§3.5） </summary>
        public const uint G2C_RankQueryResponse = 402663220;
        /// <summary> 客户端提交兑换码请求（玩家身份从会话取，不在请求中携带账号） </summary>
        public const uint C2G_RedeemCodeRequest = 268445493;
        /// <summary> 服务端兑换裁决响应 </summary>
        public const uint G2C_RedeemCodeResponse = 402663221;
        /// <summary> 客户端请求改名(身份从会话取,不带账号 / 不带费用 / 不带次数——服务端按 PlayerDoc.RenameCount 自己算) </summary>
        public const uint C2G_RenameRequest = 268445494;
        /// <summary> 服务端改名裁决响应 </summary>
        public const uint G2C_RenameResponse = 402663222;
        /// <summary> 客户端请求购买一步塔罗牌进度(身份从会话取;本步成本由服务端按 TbTarotCard.UnlockCosts[当前步] 自算,客户端不上报) </summary>
        public const uint C2G_TarotPurchaseRequest = 268445495;
        /// <summary> 服务端购买裁决响应 </summary>
        public const uint G2C_TarotPurchaseResponse = 402663223;
        ...
        public const uint C2G_WishForEnergyRequest = 268445496;
        /// <summary> 服务端祈愿裁决响应 </summary>
        public const uint G2C_WishForEnergyResponse = 402663224;
        /// <summary> 客户端请求清空自己的玩家数据(身份从会话取,不携带 playerId / 不接受指定清别人) </summary>
        public const uint C2G_ClearPlayerDataRequest = 268445497;
        /// <summary> 服务端清档裁决响应 </summary>
        public const uint G2C_ClearPlayerDataResponse = 402663225;
        /// <summary> 客户端 GM 清盘请求(身份从会话取,不携带账号) </summary>
        public const uint C2G_ClearBoardRequest = 268445498;
        /// <summary> 服务端清盘裁决 + 最新权威态 </summary>
        public const uint G2C_ClearBoardResponse = 402663226;
        /// <summary> 客户端 GM 清背包请求(身份从会话取,不携带账号) </summary>
        public const uint C2G_ClearInventoryRequest = 268445499;
        /// <summary> 服务端清背包裁决响应 </summary>
        public const uint G2C_ClearInventoryResponse = 402663227;
        /// <summary> 客户端 GM 发测试道具请求(身份从会话取,不携带账号) </summary>
        public const uint C2G_GrantTestItemRequest = 268445500;
        /// <summary> 服务端发测试道具裁决响应 </summary>
        public const uint G2C_GrantTestItemResponse = 402663228;
    }
}