...
///   - TargetId:货币指 TbCurrency 资源 id(经 InventoryServiceHelper.MapCurrencyTypeToProperty 映射服务端 PropertyType);道具指 TbItemDef 道具 id。
...
public sealed class RewardEntryDoc
{
    ...
    /// <summary>目标 id:货币指 TbCurrency id,道具指 TbItemDef id。</summary>
